...
import { formatCurrency } from './business/businessData';
    ...
    <div className="fixed inset-0 bg-black/60 z-[100] flex items-center justify-center p-4">
      ...
      `}>
        ...
        <button
          ...
          className="w-full bg-gradient-to-r from-green-500 to-emerald-500 text-white py-3 rounded-xl font-bold text-base hover:scale-105 transition-transform"
        >
          Collect Earnings
        </button>
      </div>
